...
public class Demo8 {
    ...
    public static void main(String[] args) throws InterruptedException, ExecutionException {
        ...
        List<Future<String>> futures = executorService.invokeAll//запускает все потоки
                (Arrays.asList(

                        () -> {
                            System.out.println("first run at " + LocalTime.now());
                            return "first thread";
                        },
                        () -> "second thread",
                        () -> "third thread",
        ...
        System.out.println("now is " + LocalTime.now());
